Shader ".poiyomi/★ Poiyomi Pro ★"
{
    Properties
    {
        ...
        [HideInInspector] shader_master_label ("<color=#000000ff>Poiyomi Pro V7.1.21</color>", Float) = 0
        ...
        _ClippingMask ("Alpha Map", 2D) = "white" { }
        ...
        [Enum(Ramp Texture, 0, Math Gradient, 1, Shade Mapping, 2)] _LightingRampType ("Ramp Type--{condition_show:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingMode==0},condition2:{type:PROPERTY_BOOL,data:_LightingShadingEnabled==1}}}", Int) = 0
        // Shade Maps
        _1st_ShadeColor ("1st ShadeColor--{condition_show:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingShadingEnabled==1},condition2:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingMode==0},condition2:{type:PROPERTY_BOOL,data:_LightingRampType==2}}}}", Color) = (1,1,1,1)
        ...
        [HideInInspector][Vector2]_1st_ShadeMapPan ("Panning--{condition_show:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingShadingEnabled==1},condition2:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingMode==0},condition2:{type:PROPERTY_BOOL,data:_LightingRampType==2}}}}", Vector) = (0, 0, 0, 0)
        [HideInInspector][Enum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, DistortedUV1, 4)] _1st_ShadeMapUV ("UV--{condition_show:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingShadingEnabled==1},condition2:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingMode==0},condition2:{type:PROPERTY_BOOL,data:_LightingRampType==2}}}}", Int) = 0
        [HideInInspector][ToggleUI]_Use_1stShadeMapAlpha_As_ShadowMask("1st ShadeMap.a As ShadowMask--{condition_show:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingShadingEnabled==1},condition2:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingMode==0},condition2:{type:PROPERTY_BOOL,data:_LightingRampType==2}}}}", Float ) = 0
        [HideInInspector][ToggleUI]_1stShadeMapMask_Inverse("1st ShadeMapMask Inverse--{condition_show:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingShadingEnabled==1},condition2:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingMode==0},condition2:{type:PROPERTY_BOOL,data:_LightingRampType==2}}}}", Float ) = 0
        ...
        _2nd_ShadeColor ("2nd ShadeColor--{condition_show:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingShadingEnabled==1},condition2:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingMode==0},condition2:{type:PROPERTY_BOOL,data:_LightingRampType==2}}}}", Color) = (1,1,1,1)
        ...
        [HideInInspector][Vector2]_2nd_ShadeMapPan ("Panning--{condition_show:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingShadingEnabled==1},condition2:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingMode==0},condition2:{type:PROPERTY_BOOL,data:_LightingRampType==2}}}}", Vector) = (0, 0, 0, 0)
        [HideInInspector][Enum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, DistortedUV1, 4)] _2nd_ShadeMapUV ("UV--{condition_show:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingShadingEnabled==1},condition2:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingMode==0},condition2:{type:PROPERTY_BOOL,data:_LightingRampType==2}}}}", Int) = 0
        [HideInInspector][ToggleUI]_Use_2ndShadeMapAlpha_As_ShadowMask("2nd ShadeMap.a As ShadowMask--{condition_show:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingShadingEnabled==1},condition2:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingMode==0},condition2:{type:PROPERTY_BOOL,data:_LightingRampType==2}}}}", Float ) = 0
        [HideInInspector][ToggleUI]_2ndShadeMapMask_Inverse("2nd ShadeMapMask Inverse--{condition_show:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingShadingEnabled==1},condition2:{type:AND,condition1:{type:PROPERTY_BOOL,data:_LightingMode==0},condition2:{type:PROPERTY_BOOL,data:_LightingRampType==2}}}}", Float ) = 0
        ...
        [ThryToggle(_BRDFMetallicGlossMap)]_EnableMetallic ("Enable Metallics", Float) = 0
        ...
        [HideInInspector][Enum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, DistortedUV1, 4)] _DepthGradientUV ("UV", Int) = 0
        ...
        [HideInInspector][Enum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, DistortedUV1, 4)] _DepthMaskUV ("UV", Int) = 0      
        ...
        [HideInInspector][Enum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, DistortedUV1, 4)] _GrabPassBlendMapUV ("UV", Int) = 0
        ...
        [HideInInspector]_ClippingMaskAnimated ("Alpha Map", Int) = 0
        [HideInInspector]_ClippingMaskPanAnimated ("Panning", Int) = 0
        [HideInInspector]_ClippingMaskUVAnimated ("UV", Int) = 0
        ...
        [HideInInspector]_MainBrightnessAnimated ("Shift Speed", Int) = 0
        [HideInInspector]_MainColorAdjustTextureAnimated ("Mask", Int) = 0
        [HideInInspector]_MainColorAdjustTexturePanAnimated ("Panning", Int) = 0
        [HideInInspector]_MainColorAdjustTextureUVAnimated ("UV", Int) = 0
        ...
        // Decal Texture
        [HideInInspector]_DecalEnabledAnimated ("", Int) = 0
        [HideInInspector]_DecalColorAnimated ("", Int) = 0
        [HideInInspector]_DecalEmissionStrengthAnimated ("", Int) = 0
        [HideInInspector]_DecalTextureAnimated ("", Int) = 0
        [HideInInspector]_DecalTexturePanAnimated ("", Int) = 0
        [HideInInspector]_DecalTextureUVAnimated ("", Int) = 0
        [HideInInspector]_DecalMaskAnimated ("", Int) = 0
        [HideInInspector]_DecalMaskPanAnimated ("", Int) = 0
        [HideInInspector]_DecalMaskUVAnimated ("", Int) = 0
        [HideInInspector]_DecalTiledAnimated ("", Int) = 0
        [HideInInspector]_DecalScaleAnimated ("", Int) = 0
        [HideInInspector]_DecalPositionAnimated ("", Int) = 0
        [HideInInspector]_DecalRotationAnimated ("", Int) = 0
        [HideInInspector]_DecalRotationSpeedAnimated ("", Int) = 0
        [HideInInspector]_DecalBlendTypeAnimated ("", Int) = 0
        [HideInInspector]_DecalBlendAlphaAnimated ("", Int) = 0
        [HideInInspector]_DecalHueShiftEnabledAnimated ("", Int) = 0
        [HideInInspector]_DecalHueShiftSpeedAnimated ("", Int) = 0
        [HideInInspector]_DecalHueShiftAnimated ("", Int) = 0
        ...
        // Shademaps
        [HideInInspector]_1st_ShadeColorAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_1st_ShadeMapAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_1st_ShadeMapPanAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_1st_ShadeMapUVAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_Use_1stShadeMapAlpha_As_ShadowMaskAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_1stShadeMapMask_InverseAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_Use_BaseAs1stAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_2nd_ShadeColorAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_2nd_ShadeMapAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_2nd_ShadeMapPanAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_2nd_ShadeMapUVAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_Use_2ndShadeMapAlpha_As_ShadowMaskAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_2ndShadeMapMask_InverseAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_Use_1stAs2ndAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_BaseColor_StepAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_BaseShade_FeatherAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_ShadeColor_StepAnimated ("Enable Shading-",Int) = 0
        [HideInInspector]_1st2nd_Shades_FeatherAnimated ("Enable Shading-",Int) = 0
        ...
        // Rim Hue
        [HideInInspector]_RimHueShiftEnabledAnimated ("UV", Int) = 0
        [HideInInspector]_RimHueShiftSpeedAnimated ("UV", Int) = 0
        [HideInInspector]_RimHueShiftAnimated ("UV", Int) = 0
        ...
        // BRDF
        _BRDFMetallicGlossMapAnimated ("", Int) = 0
        _BRDFMetallicGlossMapToolTipAnimated ("", Int) = 0
        _BRDFInvertGlossinessAnimated ("", Int) = 0
        _BRDFMetallicGlossMapPanAnimated ("", Int) = 0
        _BRDFMetallicGlossMapUVAnimated ("", Int) = 0
        _BRDFSpecularMapAnimated ("", Int) = 0
        _BRDFSpecularMapToolTipAnimated ("", Int) = 0
        _BRDFSpecularMapPanAnimated ("", Int) = 0
        _BRDFSpecularMapUVAnimated ("", Int) = 0
        _BRDFMetallicMapAnimated ("", Int) = 0
        _BRDFMetallicMapToolTipAnimated ("", Int) = 0
        _BRDFMetallicMapPanAnimated ("", Int) = 0
        _BRDFMetallicMapUVAnimated ("", Int) = 0
        _BRDFMetallicAnimated ("", Int) = 0
        _BRDFGlossinessAnimated ("", Int) = 0
        _BRDFReflectanceAnimated ("", Int) = 0
        _BRDFAnisotropyAnimated ("", Int) = 0
        _BRDFReflectionsEnabledAnimated ("", Int) = 0
        _BRDFSpecularEnabledAnimated ("", Int) = 0
        _BRDFFallbackAnimated ("", Int) = 0
        _BRDFForceFallbackAnimated ("", Int) = 0
        ...
        [HideInInspector]_MatcapHueShiftEnabledAnimated ("Normal to use", Int) = 0
        [HideInInspector]_MatcapHueShiftSpeedAnimated ("Normal to use", Int) = 0
        [HideInInspector]_MatcapHueShiftAnimated ("Normal to use", Int) = 0
        ...
        [HideInInspector]_Matcap2HueShiftEnabledAnimated ("Normal to use", Int) = 0
        [HideInInspector]_Matcap2HueShiftSpeedAnimated ("Normal to use", Int) = 0
        [HideInInspector]_Matcap2HueShiftAnimated ("Normal to use", Int) = 0
        ...
        [HideInInspector]_FlipbookCrossfadeEnabledAnimated ("Current Frame", Int) = 0
        [HideInInspector]_FlipbookCrossfadeRangeAnimated ("Current Frame", Int) = 0
        [HideInInspector]_FlipbookHueShiftEnabledAnimated ("Current Frame", Int) = 0
        [HideInInspector]_FlipbookHueShiftSpeedAnimated ("Current Frame", Int) = 0
        [HideInInspector]_FlipbookHueShiftAnimated ("Current Frame", Int) = 0
        ...
        [HideInInspector]_DissolveHueShiftEnabledAnimated ("End Point", Int) = 0
        [HideInInspector]_DissolveHueShiftSpeedAnimated ("End Point", Int) = 0
        [HideInInspector]_DissolveHueShiftAnimated ("End Point", Int) = 0
        [HideInInspector]_DissolveEdgeHueShiftEnabledAnimated ("End Point", Int) = 0
        [HideInInspector]_DissolveEdgeHueShiftSpeedAnimated ("End Point", Int) = 0
        [HideInInspector]_DissolveEdgeHueShiftAnimated ("End Point", Int) = 0
        ...
        // Glitter Hue Shift
        [HideInInspector]_GlitterHueShiftEnabledAnimated ("", Int) = 0
        [HideInInspector]_GlitterHueShiftSpeedAnimated ("", Int) = 0
        [HideInInspector]_GlitterHueShiftAnimated ("", Int) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Metal
            #pragma shader_feature _BRDFMetallicGlossMap
            // Poi Shader Model
